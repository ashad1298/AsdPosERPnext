...
export default {
  ...
  methods: {
      ...
      return frappe
        ...
        .then((r) => {
          if (r.message) {
            ...
            eventBus.emit("payments_register_pos_profile", r.message);
        ...
        frappe.call({
          ...
          callback: (r) => {
            ...
            if (!r.exc) {
              ...
              eventBus.emit("set_customer_info_to_edit", vm.customer_info);
            }
          },
        });
      }
    ...
    onInvoiceSelected(event) {
      eventBus.emit("set_customer", event.item.customer);
    },
